...
This version of the Tic Tac Toe model is implemented with a single string.
...
class TicTacToeModel:
    ...
    # Use a class attribute for the two players in the game.
    PLAYERS = [ "X", "O" ]
    ...
    def __init__( self ):
        ...
        self._board = "0123456789"
        # NOTE: To make the string indices align with the square numbers,
        # the first character in the string is ignored.

        # This version of the board keeps track of the current player
        # with an integer value that alternates between 0 and 1.
        # This value is used as an index into TicTacToeModel.PLAYERS.
        # Why do this? Just to further illustrate different models!
        self._current_player = 0  # Player X goes first.
    ...
    def current_player( self ):
        ...
        return TicTacToeModel.PLAYERS[ self._current_player ]
    ...
    def make_move( self, square ):
        ...
        if square < 1 or square > 9:
            ...
            self._board = self._board.replace( str( square ), TicTacToeModel.PLAYERS[ self._current_player ] )
            # This bit of math alternates current player between 0 and 1.
            self._current_player = self._current_player * -1 + 1
