...
def exercise3():
    ...
    while len( filename ) > 1:
        ...
        data_tuple = file_info( filename )
        easygui.msgbox( "Lines: {}, Words: {}, Characters: {}".format( data_tuple[0], data_tuple[1], data_tuple[2] ))
...
def file_info( filename ):
    """Builds and returns a tuple with file information (lines, words, and characters).
    ...
    tuple_a = ( len(data_lines), len(data_words), len(data_string) )
    return tuple_a
