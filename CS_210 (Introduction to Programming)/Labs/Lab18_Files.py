...
def exercise3():
    ...
    for x in range(len(data)):
        data[x] = last_name_first( data[x] )
    data.sort()

    with open( "./data/Names_Sorted.txt", "w") as output_file:
        for line in data:
...
def last_name_first( name ):
    ...
    name = name_list[2] + ", " + name_list[0] + " " + name_list[1][0] + "."
...
def exercise4():
    ...
    with open( "./data/Test_rot13.txt", "w" ) as output_file:
        for word in data_words:
            print(rot13(word), file=output_file)
